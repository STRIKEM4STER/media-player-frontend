  ...
  return (
    ...
    {allHisVideo?.length > 0 ?  <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-10 tyable-responsive ">
          <table className='table table-bordered mt-5' >
            <thead>
              <tr>
                ...
                <th className='text-center' >Time Stamps</th>
            ...
            <tbody>
              ...
              { allHisVideo?.map((item, index)=>(
                ...
                <td className='text-center' > <button onClick={()=>handleDelete(item?.id)} type='button' className='btn btn-danger' > <FontAwesomeIcon icon={faTrash} /> </button> </td>
              </tr>
              )) }
            </tbody>
          </table>
    ...
    : 
    <h4 className="text-center text-danger">No watch history found....</h4> 
      }
